...
export function createProgram(): Command {
  ...
  program.addHelpText(
    ...
    [
      ...
      "  2. cd my-workspace",
      "  3. maestro workspace install --dry-run",
      "  4. maestro workspace install",
      "  5. maestro repo bootstrap",
      "  6. maestro workspace doctor",
      "",
      "Workspace model:",
      ...
      "",
      "Output model:",
      "  - workspace, repo, and worktree commands print human-readable reports on a TTY; use --format json or pipe to get JSON (envelope: {data, schemaVersion: 1}).",
      "  - precedence: --json > --format > MAESTRO_FORMAT > isTTY ? human : json.",
      "",
